sudo sed -i 's|https://mirrors.ustc.edu.cn/proxmox|http://download.proxmox.com|g' /etc/apt/ceph.list
sudo sed -i 's|https://mirrors.ustc.edu.cn/proxmox|http://download.proxmox.com|g' /etc/apt/pve-no-subscription.list
